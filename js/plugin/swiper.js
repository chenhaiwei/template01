...
var Swiper = function (selector, params) {
    ...
    var defaults = {
        ...
        //callbacks
        //onSlideChangeStart会导致自动轮播也上报...
        onTouchEnd:function(swiper){
            var target = $(swiper.visibleSlides[0]).find('[monitor]');
            if(target.length){
                $TK.click(target.attr('monitor'));
            }
        }
    };
    params = params || {};
 ...
 */
Swiper.prototype.plugins.progress = function(swiper) {
    ...
    function calcProgress(transform) {
        ...
        if (swiper.params.centeredSlides === true) {
            offsetCenter = isH ? -transform.x + swiper.width / 2 : -transform.y + swiper.height / 2;
        } else {
        ...
        // Callback
        if (swiper.params.onProgressChange) {
            swiper.fireCallback(swiper.params.onProgressChange, swiper);
        }
    }
